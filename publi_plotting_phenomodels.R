...
#plot(Met.week$week,Met.week$gdd)


expl <- read.table(paste(fl_nme,"/Results/Fieldpics_12052020_probabilities_all/prct_Gel_all.csv",sep=""),sep=";",header=T)
#treatments <- c("C","T")
c <- "FM"
...
for(l in locations){
  ...
  #plot(cat_prc[,"id"],cat_prc[,3],type="l") 
...
dev.print(png,paste(fl_nme,"/Graphs/Fig5_4panels_01102020.png",sep=""),height=500)
